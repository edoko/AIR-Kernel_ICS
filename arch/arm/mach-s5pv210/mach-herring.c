...
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_FIMC0 (4608 * SZ_1K) //6144
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_FIMC1 (0	* SZ_1K) //9900
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_FIMC2 (5120 * SZ_1K) //6144
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_MFC0 (16384 * SZ_1K) // 16384
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_MFC1 (16384 * SZ_1K) // 16384
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_FIMD (S5PV210_LCD_WIDTH * \
					     S5PV210_LCD_HEIGHT * 4 * \
					     (CONFIG_FB_S3C_NR_BUFFERS + \
						 (CONFIG_FB_S3C_NUM_OVLY_WIN * \
						  CONFIG_FB_S3C_NUM_BUF_OVLY_WIN)))
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_JPEG (8192 * SZ_1K) // 8192/2
